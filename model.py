...
class EfficientPhys(nn.Module):
    ...
    def __init__(self, in_channels=3, nb_filters1=32, nb_filters2=64, kernel_size=3, dropout_rate1=0.25,
                 dropout_rate2=0.5, pool_size=(2, 2), nb_dense=128, frame_depth=20, img_size=36, mode="regression"):
        ...
        # Dense layers
        # TODO: Change the dense feature size for 28x28 images.
        if  img_size == 28:
            self.final_dense_1 = nn.Linear(800, self.nb_dense, bias=True)
        elif img_size == 36:
